...
class ContactUs extends Base {
    ...
    get subjectField() { return $('[data-qa="subject"]'); }
    get messageField() { return $('[data-qa="message"]'); }

    get uploadFileButton() { return $('[name="upload_file"]'); }
    get submitButton() { return $('[data-qa="submit-button"]'); }
    get homeButton() { return $('.btn.btn-success'); }

    async sendFeedback(userData) {
        await Header.goToPageByHeaderButtonName('contactUs');
